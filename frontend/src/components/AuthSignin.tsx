...
const AuthSignin = () => {
    ...
    return (
        <div className="h-screen flex justify-center items-center bg-gray-50 px-4 md:px-0">
            <div className="p-4 w-full max-w-md bg-white shadow-md rounded-md">
                <h1 className="text-2xl md:text-3xl font-bold text-center">Sign in to your Account</h1>
...
function LabelledInputs({ label, placeholder, onChange, type }: LabelledInputType) {
    return (
        <div className="mb-4">
            <label className="block text-gray-900 text-sm font-bold mb-2">{label}</label>
            <input
                onChange={onChange}
