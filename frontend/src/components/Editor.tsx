...
const Editor = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-8">
      <div className="editor w-full max-w-4xl bg-white rounded-lg shadow-md p-8">
        ...
        <form>
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-md p-3 text-sm focus:ring-blue-500 focus:border-blue-500 outline-none mb-4"
            value={title}
            onChange={(e) => setTitle(e.target.value)}
            required
          />
          <p className="text-xs text-gray-500 mb-4">
            Make it catchy and engaging for readers.
          </p>
